...
// @Param data body ushield.UserUsdtDeposits true "创建userUsdtDeposits表"
...
func (userUsdtDepositsApi *UserUsdtDepositsApi) CreateUserUsdtDeposits(c *gin.Context) {
	...
	var userUsdtDeposits ushield.UserUsdtDeposits
...
// @Accept application/json
// @Produce application/json
// @Param data body ushield.UserUsdtDeposits true "删除userUsdtDeposits表"
...
// @Accept application/json
// @Produce application/json
// @Param data body ushield.UserUsdtDeposits true "更新userUsdtDeposits表"
...
// @Success 200 {object} response.Response{data=ushield.UserUsdtDeposits,msg=string} "查询成功"
...
// @Accept application/json
// @Produce application/json
// @Param data query ushieldReq.UserUsdtDepositsSearch true "分页获取userUsdtDeposits表列表"
...
func (userUsdtDepositsApi *UserUsdtDepositsApi) GetUserUsdtDepositsList(c *gin.Context) {
	...
	var pageInfo ushieldReq.UserUsdtDepositsSearch
