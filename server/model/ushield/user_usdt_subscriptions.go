...
// 自动生成模板UserUsdtSubscriptions
package ushield
import (
	"time"
)

// userUsdtSubscriptions表 结构体  UserUsdtSubscriptions
...
// TableName userUsdtSubscriptions表 UserUsdtSubscriptions自定义表名 user_usdt_subscriptions
